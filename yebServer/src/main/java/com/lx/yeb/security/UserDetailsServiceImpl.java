...
public class UserDetailsServiceImpl implements UserDetailsService{
     ...
     */
    @Override
    public YebUserDetails loadUserByUsername(String username) throws UsernameNotFoundException{
        ...
        return new YebUserDetails(yebUser.getUsername(), yebUser.getPassword(), yebUser.getIcon(), yebUser.getRole(), yebUser
                .getEnabled() == 1, list);
    }
}
